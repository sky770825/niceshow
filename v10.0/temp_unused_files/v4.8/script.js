...
function handleTouchStart(e) {
    ...
    marqueeInteraction.startY = touch.clientY;
    marqueeInteraction.currentX = touch.clientX;
    marqueeInteraction.currentY = touch.clientY;
    ...
    marqueeInteraction.isHorizontalSwipe = false;
}
...
function handleTouchMove(e) {
    ...
    const deltaY = Math.abs(marqueeInteraction.currentY - marqueeInteraction.startY);
    
    // 判斷是否為水平滑動（水平移動距離大於垂直移動距離的2倍）
    const isHorizontalSwipe = deltaX > deltaY * 2 && deltaX > 15;
    
    if (isHorizontalSwipe && !marqueeInteraction.isDragging) {
        marqueeInteraction.isDragging = true;
        marqueeInteraction.isHorizontalSwipe = true;
    ...
    if (marqueeInteraction.isDragging && marqueeInteraction.isHorizontalSwipe) {
        e.preventDefault();
