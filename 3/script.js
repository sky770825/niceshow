...
let contactButtonVisible = true; // 預設顯示按鈕
...
function initializeContactButton() {
    ...
    if (!floatingButton || !contactButtonMain) {
    ...
    function updateFloatingButtonPosition() {
        ...
        floatingButton.style.alignItems = 'flex-end';
        floatingButton.style.gap = '10px';
    ...
    document.addEventListener('scroll', updateFloatingButtonPosition);
    
    // 手機版特殊事件
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        document.addEventListener('touchmove', updateFloatingButtonPosition);
    ...
    // 定期檢查位置
    setInterval(updateFloatingButtonPosition, 500);
